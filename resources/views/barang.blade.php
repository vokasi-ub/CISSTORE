...
<div class="wrapper">
  ...
  <center><h1> barang </h1>
<table border=1>
  <tr><th>id</th><th>id_type</th><th>id_merk</th><th>nama_barang</th><th>asal_produksi</th><th>deskripsi</th><th>harga</th><th>stok</th><th>Tanggal Input Data</th><th>Opsi</th></tr>
  @foreach($barang as $barang)
    <tr>
      ...
      <td>{{$barang->harga}}</td>
      <td>{{$barang->stok}}</td>
      <td>{{$barang->tanggal_input_data}}</td>
            ...
            <div class="box-body no-padding">
              <table class="table table-condensed">
                <tr>
                 ...
                 <th>harga</th>
                 <th>stok</th>
                  <th style="width: 40px">tanggal_input_data</th>
                </tr>
                <tr>
                  <td>1.</td>
